...
#     log.error("Error at wing_structural_layout", exc_info = True)
    ...
    ToW_takeoff = (k_TO/(airport_departure['tora']*aircraft['CL_maximum_takeoff']))*WtoS_takeoff
    ...
    ToW_missed_approach = missed_approach_climb_OEI(vehicle, airport_destination, aircraft['maximum_takeoff_weight']*GRAVITY,aircraft['maximum_landing_weight']*GRAVITY)
