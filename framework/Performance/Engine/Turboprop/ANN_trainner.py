...
nn_unit = neural_network.MLPRegressor(hidden_layer_sizes=(50,50,50), activation='relu', 
                                      solver='lbfgs', max_iter=1000, learning_rate ='constant', learning_rate_init = 0.001)
