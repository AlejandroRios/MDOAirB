...
def PW120model(altitude, mach, throttle_position):
    ...
    Tt4 = Tt4*throttle_position        # Burner exit temperature
    # =========================================================================
    # Design cosntants:
    ...
    (F, fuel_flow, P_TO, m0_dot, S, S_P_TO, f0, eta_P, eta_TH, eta_O, C_c, C_prop,
